...
class Delete extends Component {
    ...
    deleteSubmit = (event) => {
        ...
        axios.delete(`https://travellog-7th-backend.herokuapp.com/places/${this.state.deleteid}`)
            .then(res => {
                console.log(res);
                console.log(res.data);
                alert('Delete completed. Click go back to move to Places');
            })
    }
    render() {
        return (
